...
public class BaseScreenTest {
     ...
     * assertTrue(menuScreen.gamePort instanceof FitViewport,
     * "gamePort should be of type FitViewport.");
     * assertTrue(menuScreen.gameCam instanceof OrthographicCamera,
     * "gameCam should be of type OrthographicCamera.");
     * 
     * // Assert that the camera is centered
     * assertEquals(Hoytekken.V_WIDTH / 2f, menuScreen.gameCam.position.x,
     * "Camera X position should be centered.");
     * assertEquals(Hoytekken.V_HEIGHT / 2f, menuScreen.gameCam.position.y,
     * "Camera Y position should be centered.");
     * 
     * }
     * 
     * @Test
     ...
     * 
     * // assert aspect ratio is maintained
     * float originalAspectRatio = menuScreen.gamePort.getWorldWidth() /
     * menuScreen.gamePort.getWorldHeight();
     ...
     * float newAspectRatio = newWidth / newHeight;
     * 
     * assertEquals(originalAspectRatio, newAspectRatio, 0.01,
     * "Aspect ratio should be maintained after resize.");
     * assertEquals(800, newWidth, "Screen width should be 800.");
     * assertNotEquals(600, newHeight, "Height should not be 600.");
     * assertEquals(newWidth / newAspectRatio, newHeight,
     * "Height should be adjusted to maintain aspect ratio.");
     * 
     * // assert screens are resized for different parameters
     * menuScreen.resize(1000, 800);
     * assertEquals(1000, menuScreen.gamePort.getScreenWidth(),
     * "Screen width should be 1000.");
     * assertEquals(1000 / newAspectRatio, menuScreen.gamePort.getScreenHeight(),
     * "Screen height should be 800.");
     * 
     * menuScreen.resize(1200, 900);
     * assertEquals(1200, menuScreen.gamePort.getScreenWidth(),
     * "Screen width should be 1200.");
     * assertEquals(1200 / newAspectRatio, menuScreen.gamePort.getScreenHeight(),
     * "Screen height should be 900.");
     * 
     * // assert does not throw exception
     * assertDoesNotThrow(() -> menuScreen.resize(0, 0),
     * "Resize should not throw an exception.");
     * assertDoesNotThrow(() -> menuScreen.resize(100000, 100000),
     * "Resize should not throw an exception.");
     * 
     * }
     * 
     ...
     * 
     * // assert super implementations does not throw exceptions
     * assertDoesNotThrow(() -> menuScreen.show(),
     * "Show should not throw an exception.");
     * assertDoesNotThrow(() -> menuScreen.hide(),
     * "Hide should not throw an exception.");
     * assertDoesNotThrow(() -> menuScreen.pause(),
     * "Pause should not throw an exception.");
     * assertDoesNotThrow(() -> menuScreen.resume(),
     * "Resume should not throw an exception.");
     * assertDoesNotThrow(() -> menuScreen.dispose(),
